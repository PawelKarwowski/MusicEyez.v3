      ...
      <ul class="navbar-nav">
         ...
         <ul class="navbar-nav">
            <li class="dropdown">                
             ...
             <i class="fa fa-user-circle-o" aria-hidden="true"></i>
                        Witaj, <?php echo $_SESSION['user']; ?>!</a>
         <ul class="dropdown-menu" id="login-dp">
            ...
            <div class="col-lg-8">
                ...
                <p class="text-left"><?php echo $_SESSION['email']; ?></p>
                <p class="text-left">
...
<div class="carousel-inner">
	<div class="carousel-item active">
		...
		<div class="carousel-caption">
			...
			<input type="button" onclick="location.href='search.php';" value="Wyszukaj" class="btn btn-outline-light btn-lg" style="padding: 15px 32px;" />
